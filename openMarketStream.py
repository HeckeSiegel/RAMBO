...
spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.5 --jars C:\elasticsearch-hadoop-7.6.2\dist\elasticsearch-spark-20_2.11-7.6.2.jar openMarketStream.py 
...
spark = SparkSession \
            .builder \
            .appName("KafkaIEXStructuredStreamingOpenMarket") \
            .master("local[*]") \
...
sss.write_es(selectDF_news,"date","news")
sss.write_es(selectDF_quotes_es,"date","quotes")
sss.write_es(selectDF_company,"esid","company")
